...
export function HoverBorderGradient({
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-full border border-white/20 content-center transition duration-500 bg-white/10 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      )}
      {...props}
    >
      <div
        className={cn(
          "w-auto text-white z-10 bg-black px-12 py-5 rounded-[inherit]",
          className
        )}
      >
        {children}
